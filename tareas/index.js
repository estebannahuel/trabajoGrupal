...
module.exports = {
    tareas: leerJSON(),
    listar : function(encabezado = "LISTA DE TAREAS", tareas = this.tareas){ //recibo un array de tareas, y si no lo recibe va a hacer referencia a la propiedad tareas. La palabra reservada this hace referencia al obj donde estoy parado
        console.log(`\n******************* ${encabezado} *******************\n`.gray);
